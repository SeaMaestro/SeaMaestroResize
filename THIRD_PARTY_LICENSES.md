...
SeaMonkeyResize links the following third-party codec libraries. Their
...
available at the project link above, and the source code of SeaMonkeyResize
...
BSD-style licenses. The full list is recorded in `Cargo.lock`.
